...
pub fn install_packages(
    ...
    if manifest_text.is_some() {
        ...
        swe_vminit_pkg::run_install_step(packages, packages_dir, manifest_text, Some(&http), dest_dir, cache_base);
    } else {
        swe_vminit_pkg::run_install_step(packages, packages_dir, None, None, dest_dir, cache_base);
    }
}
